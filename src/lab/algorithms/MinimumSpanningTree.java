...
public class MinimumSpanningTree {
    ...
    public static void boruvka(Graph graph, ConsumerWithException<Edge> onVisitedEdge, ConsumerWithException<Edge> onFoundEdge, Boolean isCanceled) throws Exception {
    ...
    public static void kruskal(Graph graph, ConsumerWithException<Edge> onVisitedEdge, ConsumerWithException<Edge> onFoundEdge) throws Exception {
